...
def main():
    ...
    d1.plot(ax=ax[1,0], x="LONGITUDE", y="LATITUDE", kind="scatter", c="year", colormap="viridis", vmin =2001, vmax =2006, s=1)
    ax[1, 0].set_title(f'Argo Floats in 2002 (Total # of Floats = {len(d1)})')
    d2.plot(ax=ax[2,0], x="LONGITUDE", y="LATITUDE", kind="scatter", c="year", colormap="viridis", vmin =2001, vmax =2006, s=1)
    ax[2, 0].set_title(f'Argo Floats in 2003 (Total # of Floats = {len(d2)})')
    d3.plot(ax=ax[0,1], x="LONGITUDE", y="LATITUDE", kind="scatter", c="year", colormap="viridis", vmin =2001, vmax =2006, s=1)
    ax[0, 1].set_title(f'Argo Floats in 2004 (Total # of Floats = {len(d3)})')
    d4.plot(ax=ax[1,1], x="LONGITUDE", y="LATITUDE", kind="scatter", c="year", colormap="viridis", vmin =2001, vmax = 2006, s=1)
    ax[1, 1].set_title(f'Argo Floats in 2005 (Total # of Floats = {len(d4)})')
    d5.plot(ax=ax[2,1], x="LONGITUDE", y="LATITUDE", kind="scatter", c="year", colormap="viridis", vmin =2001, vmax=2006, s=1)
